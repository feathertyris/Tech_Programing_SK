...
from utils.resourses import resource_path
from PyQt5.QtGui import QPixmap

from services.api_client import get_function_data
...
class GraphWindow(QWidget):
    def __init__(self, on_logout=None):
        ...
        pixmap = QPixmap(resource_path("ui/formula.png"))# 👈 твоя картинка
        if pixmap.isNull():
            print("Ошибка: formula.png не найден в папке ui")
